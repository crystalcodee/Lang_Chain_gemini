...
with open(r'D:\Lang_chain\Complete-Langchain-Tutorials-main\chatmultipledocuments\.txt', 'r') as f:
...
def main():
    ...
    """
    st.header("RAG System for 'Leave No Context Behind' Paper 📰")  # Changed the header here
    st.title("Ask a Question ❔")  # Changed the title here
    ...
    pdf_path = r"D:\Lang_chain\Complete-Langchain-Tutorials-main\chatmultipledocuments\2404.07143.pdf"  # Replace with your PDF path
